...
func (x *SendEventRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *SendEventRequest) GetPayload() string {
	if x != nil {
		return x.Payload
	}
	return ""
...
func (x *SendEventRequest) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
const file_proto_event_proto_rawDesc = "" +
	"\n" +
	"\x11proto/event.proto\x12\x05proto\"P\n" +
	"\x10SendEventRequest\x12\x0e\n" +
	...
	"\fEventService\x12>\n" +
	"\tSendEvent\x12\x17.proto.SendEventRequest\x1a\x18.proto.SendEventResponseB!Z\x1fgithub.com/cotishq/kronos/protob\x06proto3"
...
var file_proto_event_proto_goTypes = []any{
	(*SendEventRequest)(nil),  // 0: proto.SendEventRequest
	(*SendEventResponse)(nil), // 1: proto.SendEventResponse
}
var file_proto_event_proto_depIdxs = []int32{
	0, // 0: proto.EventService.SendEvent:input_type -> proto.SendEventRequest
	1, // 1: proto.EventService.SendEvent:output_type -> proto.SendEventResponse
